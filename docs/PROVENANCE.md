...
| `data/raw/`, `data/bootstrap/`, `data/calibration/`, `artifacts/`, `runs/`, `logs/`, `output/` | `EXCLUDED` | No real inputs, local ledgers, checkpoints, or generated results are part of the public Git tree. |
...
license. Synthetic fixtures are generated by repository scripts and are not a
license for real data. Model weights remain excluded by default; see
